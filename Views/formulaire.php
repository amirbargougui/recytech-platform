...
if (isset($_POST['add'])) {
    ...
    $query = "INSERT INTO remboursement (codepr, id, date_achat, numero, description) VALUES (?, ?, ?, ?, ?)";
...
$message = "<html><body><h2 style=''>
your refund has been successfully processed</h2>";
$message .= "</body></html>";

// envoi du mail
$to = $email;
$subject = "Collection Schedule Reservation";
$headers = "From: medamir.bargougui@esprit.tn" . "\r\n" .
           "Reply-To: medamir.bargougui@esprit.tn" . "\r\n" .
...
<html lang="en" class="no-js">
        ...
        <div class="row s-header__inner">
            ...
            <nav class="s-header__nav">
                <ul>
                    ...
                    <li><a href="#" class="smoothscroll">Refund</a></li>
                </ul>
  ...
  <section class="signup" id="subscribe">
        ...
        <div class="signup-form">
          ...
          <form method="POST" class="register-form" onsubmit="return check()">  
            <div class="form-group" >
              <div>
                <input type="text" name="id" id="id" placeholder="Your Id " class="no-outline"/>
              </div>
              <div>
    ...
    <script src="front/js/success.js"></script>
