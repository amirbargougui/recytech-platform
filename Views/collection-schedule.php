  ...
  <div class="container-fluid">
    <div class="bg-secondary text-center rounded p-4">
      <div class="d-flex align-items-center justify-content-between mb-4">
        <h6 class="mb-0">-Select the type of your product and schedule an appointment-</h6>
      </div>
    </div>
    <div class="row text-center">
      ...
      foreach ($item_types as $item_type) {
        ...
        echo '<div class="card booking-card">';
        echo '<div class="card-body">';
        echo "<h4 class='card-title'>{$item_type['name']}</h4>";
        echo "<p class='card-text'>{$item_type['description']}</p>";
        echo "<p class='card-text'>Weight (max): {$item_type['weight']}</p>";
        echo "<a href='add_scheduling.php?id={$item_type['id']}' class='btn btn-primary'>Appointment</a>";
        echo '</div>';
        echo '</div>';
        echo '</div>';
      }
